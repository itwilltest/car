...
<center>
	...
	<%--결제하기 버튼 눌렀을때.. 컨트롤러 요청시.. 렌트 예약 정보들 전달 --%>
	<form action="CarOrderController.do" method="post">
		<p>
			<font size="13" color="blue">차량 렌트비용 : ￦${requestScope.totalreserve }원</font>
		</p>
		<p>
			<font size="13" color="blue">차량 옵션비용 : ￦${requestScope.totaloption }원</font>
		</p>
		<p>
			<font size="13" color="blue">총 비용 : ￦${ totalreserve + totaloption }원</font>
		</p>
		<%--실제 예약에 관련된 데이터를 CarOrderController.java서블릿 파일로 넘겨줌 --%>
